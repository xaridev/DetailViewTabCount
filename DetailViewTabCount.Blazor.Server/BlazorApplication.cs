...
namespace DetailViewTabCount.Blazor.Server {
    public partial class DetailViewTabCountBlazorApplication : BlazorApplication {
        public DetailViewTabCountBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void DetailViewTabCountBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
